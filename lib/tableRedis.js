 ...
 * @param cb
 */
pro.addRedisCache = function(tableName, toSet, expire, cb) {
    var table = this.tables[tableName];
    this.dataType[table[REDIS_TYPE]].addCache(this.redis, table, toSet, expire, cb);
};
 ...
 * @param cb
 */
pro.updateRedisCache = function(tableName, json, expire, cb) {
    var table = this.tables[tableName];
    var typeMgr = this.dataType[table[REDIS_TYPE]];
    typeMgr.updCache(this.redis, table, json, expire, cb);
};
